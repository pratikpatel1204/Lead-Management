                    ...
                    <form id="categoryEditForm" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <?php if($category->image): ?>
                                <img src="<?php echo e(asset($category->image)); ?>" width="80" height="60" style="object-fit:cover;border-radius:5px;">
                            <?php else: ?>
                                <img src="<?php echo e(asset('default/no-img.jpg')); ?>" width="80" height="60" style="object-fit:cover;border-radius:5px;">
                            <?php endif; ?>
                        </div>
