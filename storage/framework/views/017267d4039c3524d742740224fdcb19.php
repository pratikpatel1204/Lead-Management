...
<?php $__env->startSection('title', config('app.name') . ' || Edit Template'); ?>
        ...
        <div class="card-body">
            <form id="templateEditForm">
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <input type="text" class="form-control" name="new_name" value="<?php echo e($name); ?>">
                </div>
                        ...
                        <?php $__currentLoopData = $fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="form-check d-flex align-items-center" style="width: 30%;">
                                <input class="form-check-input field-checkbox me-2"
                                    ...
                                    <?php echo e(in_array($field->id, $selectedIds) ? 'checked' : ''); ?>>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status) {
                        ...
                        setTimeout(() => {
                            window.location.href = "<?php echo e(route('admin.template.list')); ?>";
                        }, 1500);
                    } else {
...
<?php echo $__env->make('admin.layout.main-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Lead-Management\resources\views/admin/template/edit.blade.php ENDPATH**/ ?>