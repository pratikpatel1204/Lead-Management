...
<body>
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="footer">
                <div class="copyright">
                    <p>Copyright &copy; Designed & Developed by <a href="https://qubetatechnolab.com/"
                            target="_blank">Qubeta Technolab</a> <?php echo e(date('Y')); ?></p>
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH D:\xampp\htdocs\Lead-Management\resources\views/layout/main-layout.blade.php ENDPATH**/ ?>