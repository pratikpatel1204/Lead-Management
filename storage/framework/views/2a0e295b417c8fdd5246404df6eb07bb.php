...
<head>
    <title><?php echo e(config('app.name') . ' || Email Verification'); ?></title>
                                        ...
                                        <div class="">
                                            <div class="text-center mb-3">
                                                ...
                                                <p class="mb-0">Please enter the OTP received to confirm your account
                                                    ...
                                                    <?php echo e(substr($user->email, 0, 5) . '****' . strstr($user->email, '@')); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#otpForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: "<?php echo e(route('admin.verify.otp')); ?>",
                    method: 'POST',
                    data: {
            ...
            $('#resendOtp').on('click', function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('admin.resend.otp')); ?>",
                    method: 'POST',
                    data: {
                        _token: '<?php echo e(csrf_token()); ?>',
                        email: '<?php echo e($user->email); ?>'
...
<?php /**PATH D:\xampp\htdocs\Lead-Management\resources\views/admin/auth/email_verification.blade.php ENDPATH**/ ?>