...
<?php $__env->startSection('title', config('app.name') . ' || Contact Us'); ?>
<?php $__env->startSection('content'); ?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-7 col-lg-6">
                    ...
                    <form id="inquiryForm" method="POST" class="row">
                        <?php echo csrf_field(); ?>
                        <div class="col-lg-6">
                            <input name="name" class="form-control cs_fs_14 cs_rounded_5 border-0 cs_mb_35 bg-gray"
                                type="text" placeholder="Your Name">
                        </div>
                        <div class="col-lg-6">
                            <input name="email" class="form-control cs_fs_14 cs_rounded_5 border-0 cs_mb_35 bg-gray"
                                type="email" placeholder="Email Address">
                        </div>
                        <div class="col-lg-6">
                            <input name="phone" class="form-control cs_fs_14 cs_rounded_5 border-0 cs_mb_35 bg-gray"
                                type="text" placeholder="Phone">
                        </div>
                        <div class="col-lg-6">
                            <input name="subject" class="form-control cs_fs_14 cs_rounded_5 border-0 cs_mb_35 bg-gray"
                                type="text" placeholder="Subject">
                        </div>
                        <div class="col-lg-12">
                            <textarea name="message" class="form-control cs_fs_14 cs_rounded_5 border-0 cs_mb_40 bg-gray"
                ...
                <div class="col-xl-5 col-lg-6">
                    <div class="cs_pl_60 cs_pl_lg_0 cs_pt_lg_60">
                        <div class="cs_section_heading cs_style_1 d-flex align-items-center cs_mb_40">
                            <div class="cs_section_heading_in">
                                <h3 class="cs_fs_20 cs_fs_lg_18 text-accent fw-normal cs_lh_base cs_mb_10">Contact With Us
                                </h3>
                        ...
                        <div class="d-flex align-items-center cs_mb_30">
                            ...
                            <div>
                                ...
                                <h2 class="m-0 fw-medium cs_fs_22 cs_fs_lg_18 cs_lh_base"><?php echo e($contact->phone); ?></h2>
                            </div>
                        </div>
                        <div class="d-flex align-items-center cs_mb_30">
                            <div
                            ...
                            <div>
                                ...
                                <h2 class="m-0 fw-medium cs_fs_22 cs_fs_lg_18 cs_lh_base"><?php echo e($contact->email); ?></h2>
                            </div>
                        </div>
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <h2 class="m-0 fw-medium cs_fs_22 cs_fs_lg_18 cs_lh_base"><?php echo e($contact->address); ?></h2>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- Start Google Map -->
    <div class="cs_map">
        <iframe id="map" src="<?php echo e($contact->map_link); ?>" allowfullscreen></iframe>
    </div>
    <!-- End Google Map -->
    <script>
        $('#inquiryForm').on('submit', function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('front.contact.inquery')); ?>",
                method: 'POST',
                data: formData,
...
<?php echo $__env->make('front.layout.main-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Lead-Management\resources\views/front/contact_us.blade.php ENDPATH**/ ?>