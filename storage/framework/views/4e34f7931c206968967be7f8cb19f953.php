                ...
                <div class="card-body">
                    <form id="blogForm" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="title" class="form-control" value="<?php echo e($blog->title); ?>" placeholder="Enter Blog Title" required>
                            <span class="text-danger error-title"></span>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Author Name</label>
                            <input type="text" name="author_name" class="form-control" value="<?php echo e($blog->author_name); ?>" placeholder="Enter Author Name">
                        ...
                        <div class="mb-3">
                            ...
                            <?php if($blog->image): ?>
                                <div class="mb-2">
                                    <img src="<?php echo e(asset($blog->image)); ?>" alt="Blog Image" class="img-thumbnail" width="150">
                                </div>
                            <?php endif; ?>
