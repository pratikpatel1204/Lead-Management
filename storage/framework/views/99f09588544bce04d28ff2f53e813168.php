...
?>
<!-- Start Footer -->
<footer class="cs_footer background-filled text-white" data-src="<?php echo e(asset('front/img/footer_bg.jpeg')); ?>">
    <div class="container">
        <div
            ...
            <div class="cs_footer_contact_info">
                ...
                <h2 class="text-white fw-medium m-0 cs_fs_22"><?php echo e($contact->phone); ?></h2>
            </div>
            ...
            <div class="cs_footer_contact_info">
                ...
                <h2 class="text-white fw-medium m-0 cs_fs_22"><?php echo e($contact->email); ?></h2>
            </div>
        </div>
                ...
                <div class="col-lg-4">
                    <div class="cs_footer_item cs_pt_20 cs_pb_20">
                        ...
                        <div class="cs_social_btns d-flex flex-wrap cs_column_gap_15 cs_row_gap_15 cs_transition_5">
                            <a href="<?php echo e($contact->facebook); ?>"
                                class="d-flex align-items-center justify-content-center cs_height_35 cs_width_35 text-white rounded-circle"><i
                                    class="fa-brands fa-facebook-f"></i></a>
                            <a href="<?php echo e($contact->twitter); ?>"
                                class="d-flex align-items-center justify-content-center cs_height_35 cs_width_35 text-white rounded-circle"><i
                                    class="fa-brands fa-twitter"></i></a>
                            <a href="<?php echo e($contact->linkedin); ?>"
                                class="d-flex align-items-center justify-content-center cs_height_35 cs_width_35 text-white rounded-circle"><i
                                    class="fa-brands fa-linkedin-in"></i></a>
                            <a href="<?php echo e($contact->instagram); ?>"
                                class="d-flex align-items-center justify-content-center cs_height_35 cs_width_35 text-white rounded-circle"><i
                ...
                <div class="col-lg-4 offset-lg-1">
                    <div class="cs_footer_item cs_pt_20 cs_pb_20">
                        ...
                        <ul class="cs_menu_widget text-uppercase">
                            ...
                            <li><a href="<?php echo e(route('front.our.team')); ?>">Team</a></li>
...
<script>
    $('#newsletterForm').on('submit', function(e) {
        ...
        $.ajax({
            url: "<?php echo e(route('front.newsletter.submit')); ?>",
            method: 'POST',
            data: formData,
...
<!-- End Footer -->
<?php /**PATH D:\xampp\htdocs\Lead-Management\resources\views/front/layout/footer.blade.php ENDPATH**/ ?>