...
<?php $__env->startSection('title', config('app.name') . ' || Contact Settings'); ?>
            ...
            <form id="contactSettingsForm">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea name="address" class="form-control" rows="3"><?php echo e($contact->address ?? ''); ?></textarea>
                    </div>

                    <div class="col-md-12 mb-3">
                        <label class="form-label fw-bold">Google Map Link</label>
                        <input type="text" name="map_link" class="form-control" value="<?php echo e($contact->map_link ?? ''); ?>">
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="facebook" class="form-control" value="<?php echo e($contact->facebook ?? ''); ?>">
                    </div>

                    <div class="col-md-6 mb-3">
                        <label class="form-label fw-bold">Twitter</label>
                        <input type="text" name="twitter" class="form-control" value="<?php echo e($contact->twitter ?? ''); ?>">
                    </div>

                    <div class="col-md-6 mb-3">
                        <label class="form-label fw-bold">LinkedIn</label>
                        <input type="text" name="linkedin" class="form-control" value="<?php echo e($contact->linkedin ?? ''); ?>">
                    </div>

                    <div class="col-md-6 mb-3">
                        <label class="form-label fw-bold">Instagram</label>
                        <input type="text" name="instagram" class="form-control" value="<?php echo e($contact->instagram ?? ''); ?>">
                    </div>
...
$("#contactSettingsForm").submit(function(e) {
    ...
    $.ajax({
        url: "<?php echo e(route('admin.contact.settings.update')); ?>",
        type: "POST",
        data: formData,
        processData: false,
        contentType: false,
...
<?php echo $__env->make('admin.layout.main-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Lead-Management\resources\views/admin/contact_settings.blade.php ENDPATH**/ ?>