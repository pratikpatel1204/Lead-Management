...
<?php $__env->startSection('title', config('app.name') . ' || Create Testimonial'); ?>
    ...
    <div class="content">
        ...
        <script>
            $("#testimonialForm").on('submit', function(e) {
                ...
                $.ajax({
                    url: "<?php echo e(route('admin.testimonial.store')); ?>",
                    type: "POST",
                    data: formData,
                    contentType: false,
                    processData: false,
...
<?php echo $__env->make('admin.layout.main-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Lead-Management\resources\views/admin/testimonial/create.blade.php ENDPATH**/ ?>