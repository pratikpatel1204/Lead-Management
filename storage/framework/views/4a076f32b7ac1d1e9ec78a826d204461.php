...
<?php $__env->startSection('title', config('app.name') . ' || Edit Team Member'); ?>
                ...
                <div class="card-body">
                    ...
                    <form id="teamForm" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="designation" value="<?php echo e($team->designation); ?>" class="form-control" required>
                        ...
                        <div class="mb-3">
                            ...
                            <?php if($team->image): ?>
                                <div class="mt-2">
                                    <img src="<?php echo e(asset($team->image)); ?>" width="80" height="80" style="object-fit:cover;border-radius:50%;">
                                </div>
                            <?php endif; ?>
...
$("#teamForm").on('submit', function(e) {
    ...
    $.ajax({
        url: "<?php echo e(route('admin.team.update')); ?>",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
...
<?php echo $__env->make('admin.layout.main-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Lead-Management\resources\views/admin/team/edit.blade.php ENDPATH**/ ?>