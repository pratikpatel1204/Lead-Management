                    ...
                    <div class="col-lg-5">
                        <div class="login-background position-relative d-lg-flex align-items-center justify-content-center d-none flex-wrap vh-100">
                            <div class="bg-overlay-img">
                                <img src="<?php echo e(asset('admin/img/bg/bg-01.png')); ?>" class="bg-1" alt="Img">
                                <img src="<?php echo e(asset('admin/img/bg/bg-02.png')); ?>" class="bg-2" alt="Img">
                                <img src="<?php echo e(asset('admin/img/bg/bg-03.png')); ?>" class="bg-3" alt="Img">
                            </div>
                            <div class="authentication-card w-100">
                                <div class="authen-overlay-item border w-100">
                                    ...
                                    <div class="my-4 mx-auto authen-overlay-img">
                                        <img src="<?php echo e(asset('admin/img/bg/authentication-bg-01.png')); ?>" alt="Img">
                                    </div>
                                    <div>
                                ...
                                <form id="forgotPasswordForm" class="vh-100">
                                    <div class="vh-100 d-flex flex-column justify-content-between p-4 pb-0">
                                        <div class=" mx-auto mb-5 text-center">
                                            <img src="<?php echo e(asset('admin/img/logo.png')); ?>" class="img-fluid"
                                                alt="Logo">
                                        </div>
                                        <div class="">
                                            ...
                                            <div class="text-center">
                                                <h6 class="fw-normal text-dark mb-0">Return to
                                                    <a href="<?php echo e(route('admin.login')); ?>" class="hover-a">Sign In</a>
                                                </h6>
                                            </div>
                                        </div>
    ...
    <script>
        $(document).ready(function() {
            $('#forgotPasswordForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: "<?php echo e(route('admin.forgot.password.check')); ?>",
                    type: "POST",
                    data: {
                    ...
                    success: function(res) {
                        if (res.exists) {
                            ...
                            window.location.href = "<?php echo e(route('admin.otp.verification', ':id')); ?>".replace(':id', res.user_id);
                        } else {
...
<?php /**PATH D:\xampp\htdocs\Lead-Management\resources\views/admin/auth/forgot_password.blade.php ENDPATH**/ ?>