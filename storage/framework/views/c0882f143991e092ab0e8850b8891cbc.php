            ...
            <div class="cs_top_header_in">
                <div class="cs_top_header_left">
                    <ul class="cs_top_nav d-flex flex-wrap align-items-center cs_fs_12 text-white m-0 p-0">
                        <li><b class="fw-medium text-white">Address:</b> <?php echo e($contact->address); ?></li>
                        <li>
                            <b class="fw-medium text-white"><?php echo e($contact->email); ?></b>
                        </li>
                    </ul>
                </div>
        ...
        <div class="container">
            <div class="cs_main_header_in">
                <div class="cs_main_header_left">
                    <a class="cs_site_branding" href="<?php echo e(route('front.index')); ?>">
                    ...
                    <div class="cs_nav cs_primary_font fw-medium">
                        <ul class="cs_nav_list fw-medium text-uppercase">
                            ...
                            <li class="menu-item-has-children">
                                <a href="<?php echo e(route('front.services')); ?>">Services</a>
                                <ul>
                                    <?php $__currentLoopData = $serviceCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li>
                                            <a
                                                href="<?php echo e(route('front.service.category', $category->slug)); ?>">
                    ...
                    <div class="cs_toolbox">
                        ...
                        <div class="cs_header_contact">
                            ...
                            <div class="cs_header_contact_right">
                                ...
                                <h3 class="text-white m-0 cs_fs_13"><?php echo e($contact->phone); ?></h3>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH D:\xampp\htdocs\Lead-Management\resources\views/front/layout/header.blade.php ENDPATH**/ ?>