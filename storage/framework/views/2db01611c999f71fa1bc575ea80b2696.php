                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="status" class="form-control">
                                        <option value="Active" <?php echo e($banner->status == 'Active' ? 'selected' : ''); ?>>Active
                                        </option>
                                        <option value="Inactive" <?php echo e($banner->status == 'Inactive' ? 'selected' : ''); ?>>
                                            Inactive</option>
                                    </select>
            ...
            $("#updateBannerForm").on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        setTimeout(() => {
                            window.location.href = "<?php echo e(route('admin.banner.list')); ?>";
                        }, 800);
                    },
