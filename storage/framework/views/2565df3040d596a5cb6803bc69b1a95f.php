                ...
                <div class="row">
                    <div class="col-lg-5">
                        <div
                            ...
                            <div>
                                <img src="<?php echo e(asset('admin/img/bg/authentication-bg-06.svg')); ?>" alt="Img">
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#resetPasswordForm").on("submit", function(e) {
                ...
                $.ajax({
                    url: "<?php echo e(route('admin.reset.password.submit')); ?>",
                    type: "POST",
                    data: {
...
<?php /**PATH D:\xampp\htdocs\Lead-Management\resources\views/admin/auth/reset_password.blade.php ENDPATH**/ ?>