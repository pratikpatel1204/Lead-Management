...
<?php $__env->startSection('title', config('app.name') . ' || Create Template Data'); ?>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form id="templateForm" method="POST" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <select name="name" id="templateSelect" class="form-control" required>
                            ...
                            <?php $__currentLoopData = $templateNames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="text-end">
                    <a href="<?php echo e(route('admin.template.data.list')); ?>" class="btn btn-secondary">Cancel</a>
...
<script>
    $(document).ready(function() {
        $('#templateSelect').on('change', function () {
            ...
            $.ajax({
                url: "<?php echo e(route('admin.template.data.get.fields')); ?>",
                method: "POST",
                data: {
                    name: name,
...
$(document).ready(function() {
    $('#templateForm').on('submit', function(e) {
        ...
        $.ajax({
            url: "<?php echo e(route('admin.template.data.store')); ?>",
            method: "POST",
            data: formData,
            processData: false,
            contentType: false, 
...
<?php echo $__env->make('admin.layout.main-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Lead-Management\resources\views/admin/template_data/create.blade.php ENDPATH**/ ?>