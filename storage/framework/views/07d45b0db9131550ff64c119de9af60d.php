                    ...
                    <div class="dropdown me-1">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <div class="card mb-0 border-0 shadow-none">
                                ...
                                <div class="card-body">
                                    <a href="javascript:void(0);" class="d-block pb-2">
                                    ...
                                    <a href="javascript:void(0);" class="d-block py-2 pb-0">
                                        <span class="avatar avatar-md bg-transparent-dark me-2"><i
                                ...
                                <div class="d-flex flex-column">
                                        ...
                                        <a href="javascript:void(0);">
                                            <div class="d-flex">
                                                <span class="avatar avatar-lg me-2 flex-shrink-0">
                                                    <img src="<?php echo e(asset('admin/img/profiles/avatar-27.jpg')); ?>"
                                                        alt="Profile">
                                                </span>
                                    ...
                                    <div class="border-bottom mb-3 pb-3">
                                        <a href="javascript:void(0);" class="pb-0">
                                            <div class="d-flex">
                                                <span class="avatar avatar-lg me-2 flex-shrink-0">
                                                    <img src="<?php echo e(asset('admin/img/profiles/avatar-23.jpg')); ?>"
                                                        alt="Profile">
                                                </span>
                                                <div class="flex-grow-1">
                                                    <p class="mb-1"><span
                                    ...
                                    <div class="border-bottom mb-3 pb-3">
                                        <a href="javascript:void(0);">
                                            <div class="d-flex">
                                                <span class="avatar avatar-lg me-2 flex-shrink-0">
                                                    <img src="<?php echo e(asset('admin/img/profiles/avatar-25.jpg')); ?>"
                                                        alt="Profile">
                                                </span>
                                                <div class="flex-grow-1">
                                    ...
                                    <div class="border-0 mb-3 pb-0">
                                        <a href="javascript:void(0);">
                                            <div class="d-flex">
                                                <span class="avatar avatar-lg me-2 flex-shrink-0">
                                                    <img src="<?php echo e(asset('admin/img/profiles/avatar-01.jpg')); ?>"
                                                        alt="Profile">
                                                </span>
                                                <div class="flex-grow-1">
...
<!-- /Header -->
<?php /**PATH D:\xampp\htdocs\Lead-Management\resources\views/admin/layout/header.blade.php ENDPATH**/ ?>