    ...
    <div class="content">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
            ...
            <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
                ...
                <div class="mb-2 me-2">
                    <a href="<?php echo e(route('admin.fields.sample.download')); ?>" class="btn btn-success d-flex align-items-center">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr id="row-<?php echo e($field->id); ?>">
                                    ...
                                    <td><?php echo e($field->options ?? '-'); ?></td>
                                    <td class="text-center">
                                        <a href="<?php echo e(route('admin.field.edit', $field->id)); ?>"
    ...
    <script>
        $(document).ready(function() {
            $('#excelUploadForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: "<?php echo e(route('admin.fields.bulk.upload')); ?>",
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
