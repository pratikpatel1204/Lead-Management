...
<?php $__env->startSection('title', config('app.name') . ' || Create Dropdown'); ?>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#dropdownForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: "<?php echo e(route('admin.dropdown.store')); ?>",
                    method: "POST",
                    data: form.serialize(),
...
<?php echo $__env->make('admin.layout.main-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Lead-Management\resources\views/admin/field/create_dropdown.blade.php ENDPATH**/ ?>