...
<?php $__env->startSection('content'); ?>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div
                            ...
                            <figure class="cs_swiper_parallax_bg" data-src="<?php echo e(asset('front/img/hero_slider_1.jpg')); ?>">
                                <img src="<?php echo e(asset('front/img/hero_slider_1.jpg')); ?>" alt="Slider" class="cs_entity_img">
                            ...
                            <div class="container">
                                <div class="cs_hero_text position-relative cs_zindex_5 d-inline-block">
                                    <h2 class="text-white cs_mb_5 fw-normal cs_fs_18">This Week Only for World Premier
                                    </h2>
                                    <h1 class="text-white cs_mb_16 cs_fs_60 cs_fs_lg_46">
                                        Inventive and interested <br>in innovation
                                    </h1>
                                    <p class="text-white cs_mb_20">
                                        I have been a loyal customer of this auto parts company for years and I cannot
                                        <br>recommend them enough. Their extensive selection of high-quality parts and
                                        <br> accessories.
                                    </p>
                    ...
                    <div class="swiper-slide">
                        <div
                            class="cs_hero cs_style_1 d-flex align-items-center justify-content-center background-filled position-relative overflow-hidden">
                            <figure class="cs_swiper_parallax_bg" data-src="<?php echo e(asset('front/img/hero_slider_2.jpg')); ?>">
                                <img src="<?php echo e(asset('front/img/hero_slider_2.jpg')); ?>" alt="Slider" class="cs_entity_img">
                                <div class="bg-primary opacity-75 position-absolute w-100 h-100 start-0 top-0"></div>
                            </figure>
                            <div class="container">
                                <div class="cs_hero_text position-relative cs_zindex_5 d-inline-block">
                    ...
                    <div class="swiper-slide">
                        <div
                            class="cs_hero cs_style_1 d-flex align-items-center justify-content-center background-filled position-relative overflow-hidden">
                            <figure class="cs_swiper_parallax_bg" data-src="<?php echo e(asset('front/img/hero_slider_3.jpg')); ?>">
                                <img src="<?php echo e(asset('front/img/hero_slider_3.jpg')); ?>" alt="Slider" class="cs_entity_img">
                                <div class="bg-primary opacity-75 position-absolute w-100 h-100 start-0 top-0"></div>
                            </figure>
                            <div class="container">
                                <div class="cs_hero_text position-relative cs_zindex_5 d-inline-block">
                ...
                <div class="col-xl-3 col-md-6">
                    <div
                        ...
                        <div class="cs_service_iconbox d-flex align-items-center cs_mb_20">
                            ...
                            <h2 class="cs_lh_base cs_fs_20 cs_fs_lg_18 m-0"><a href="services-details.html"
                                    class="inline-block">Accounting and Bookkeeping</a></h2>
                        </div>
                        ...
                        <div class="cs_service_thumb position-relative cs_rounded_5">
                            ...
                            <div class="cs_service_thumb-in position-relative-in background-filled h-100"
                                data-src="<?php echo e(asset('front/img/service_1.jpeg')); ?>"></div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6">
                    <div
                        ...
                        <div class="cs_service_iconbox d-flex align-items-center cs_mb_20">
                            ...
                            <h2 class="cs_lh_base cs_fs_20 cs_fs_lg_18 m-0"><a href="services-details.html"
                                    class="inline-block">IT Support and Consulting</a></h2>
                        </div>
                        ...
                        <div class="cs_service_thumb position-relative cs_rounded_5">
                            ...
                            <div class="cs_service_thumb-in position-relative-in background-filled h-100"
                                data-src="<?php echo e(asset('front/img/service_2.jpeg')); ?>"></div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6">
                    <div
                        ...
                        <div class="cs_service_iconbox d-flex align-items-center cs_mb_20">
                            ...
                            <h2 class="cs_lh_base cs_fs_20 cs_fs_lg_18 m-0"><a href="services-details.html"
                                    class="inline-block">Marketing and Advertising</a></h2>
                        </div>
                        ...
                        <div class="cs_service_thumb position-relative cs_rounded_5">
                            ...
                            <div class="cs_service_thumb-in position-relative-in background-filled h-100"
                                data-src="<?php echo e(asset('front/img/service_3.jpeg')); ?>"></div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6">
                    <div
                        ...
                        <div class="cs_service_iconbox d-flex align-items-center cs_mb_20">
                            ...
                            <h2 class="cs_lh_base cs_fs_20 cs_fs_lg_18 m-0"><a href="services-details.html"
                                    class="inline-block">Human Resources</a></h2>
                        </div>
                        <p class="cs_mb_24">Assistance with HR-related tasks such as recruitment, training,
                            performance.</p>
                        <div class="cs_service_thumb position-relative cs_rounded_5">
                            <a href="services-details.html"
                                class="cs_service_btn d-flex align-items-center justify-content-center rounded-circle position-absolute text-white">
                            ...
                            <div class="cs_service_thumb-in position-relative-in background-filled h-100"
                                data-src="<?php echo e(asset('front/img/service_4.jpeg')); ?>"></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-6 cs_mb_lg_55">
                    <div class="cs_experience cs_style_1 position-relative">
                        <div class="cs_experience_thumb">
                            <img src="<?php echo e(asset('front/img/experience_img.jpg')); ?>" alt="Thumb"
                                class="position-relative cs_zindex_3 cs_rounded_15">
                            <div class="cs_experience_shape"><img src="<?php echo e(asset('front/img/experience_shape_1.png')); ?>"
                        ...
                        <div class="cs_experience_box background-filled text-center bg-white cs_rounded_10 position-absolute bottom-0 end-0 cs_zindex_3 d-flex flex-column justify-content-center align-items-center"
                            data-src="<?php echo e(asset('front/img/experience_bg.jpeg')); ?>">
                    ...
                    <div class="cs_about cs_style_1">
                        <div class="cs_section_heading cs_style_1 d-flex align-items-center cs_mb_15">
                            <div class="cs_section_heading_in">
                                ...
                                <h2 class="cs_fs_48 cs_fs_lg_36 cs_mb_20">Get Ready for Success with <span
                                        class="text-accent">Bizmax</span> Your Path to Growth.</h2>
                                <p class="m-0">Providing legal advice, contract drafting, compliance assistance,
                                    intellectual property protection, and other legal support for businesses. Creating
                                    visual content, such as logos, brochures, infographics, and other branding
                                    materials.</p>
                            </div>
                        </div>
                        <div class="cs_progressbar cs_style_1 cs_mb_20">
                            ...
                            <div class="cs_progress cs_rounded_8 overflow-hidden" data-progress="90">
                                <div class="cs_progress_in bg-accent cs_rounded_8 h-100 wow fadeInLeft"
                                    data-wow-duration="0.8s" data-wow-delay="0.2s"></div>
                            </div>
                        </div><!-- .cs_progressbar -->
                            ...
                            <div class="col-lg-6">
                                <div class="cs_about-icon-box position-relative cs_mb_25">
                                    <span
                                        class="position-absolute cs_height_20 cs_width_20 top-0 start-0 cs_mt_5 bg-accent text-white cs_fs_10 d-flex align-items-center justify-content-center cs_rounded_30"><i
                                            class="fa-solid fa-angles-right"></i></span>
                                    <h3 class="cs_fs_16 cs_pl_35 cs_mb_12 cs_lh_lg">Human Resources (HR) Consulting
                                    </h3>
        ...
        <div class="cs_project_slider">
            <div class="container">
                <div
                    ...
                    <div class="cs_section_heading_in">
                        <h3 class="cs_fs_20 cs_fs_lg_18 text-accent fw-normal cs_lh_base cs_mb_10 wow fadeInLeft"
                            data-wow-duration="0.8s" data-wow-delay="0.2s">Our Latest Project</h3>
                ...
                <div class="cs_slide">
                    <div class="cs_portfolio cs_style_1 position-relative overflow-hidden">
                        ...
                        <div class="cs_portfolio_thumb d-block h-100 w-100 background-filled cs_transition_6"
                            data-src="<?php echo e(asset('front/img/portfolio_1.jpeg')); ?>"></div>
                        <h3
                            ...
                            <a href="project-details.html">Marketing Webdesign</a>
                        </h3>
                    </div>
                </div>
                <div class="cs_slide">
                    <div class="cs_portfolio cs_style_1 position-relative overflow-hidden">
                        <a href="project-details.html"
                            class="cs_portfolio_overlay cs_transition_4 position-absolute h-100 w-100 start-0 top-0 cs_zindex_1 d-block"></a>
                        <div class="cs_portfolio_thumb d-block h-100 w-100 background-filled cs_transition_6"
                            data-src="<?php echo e(asset('front/img/portfolio_2.jpeg')); ?>"></div>
                        <h3
                            class="cs_portfolio_title m-0 cs_fs_26 text-white cs_pl_50 cs_pb_45 cs_mr_50 position-relative cs_zindex_4 position-absolute start-0 bottom-0 w-100 cs_transition_4">
                            <a href="project-details.html">Marketing Webdesign</a>
                        </h3>
                ...
                <div class="cs_slide">
                    <div class="cs_portfolio cs_style_1 position-relative overflow-hidden">
                        <a href="project-details.html"
                            class="cs_portfolio_overlay cs_transition_4 position-absolute h-100 w-100 start-0 top-0 cs_zindex_1 d-block"></a>
                        <div class="cs_portfolio_thumb d-block h-100 w-100 background-filled cs_transition_6"
                            data-src="<?php echo e(asset('front/img/portfolio_3.jpeg')); ?>"></div>
                        <h3
                            class="cs_portfolio_title m-0 cs_fs_26 text-white cs_pl_50 cs_pb_45 cs_mr_50 position-relative cs_zindex_4 position-absolute start-0 bottom-0 w-100 cs_transition_4">
                            <a href="project-details.html">Marketing Webdesign</a>
                        </h3>
                ...
                <div class="cs_slide">
                    <div class="cs_portfolio cs_style_1 position-relative overflow-hidden">
                        <a href="project-details.html"
                            class="cs_portfolio_overlay cs_transition_4 position-absolute h-100 w-100 start-0 top-0 cs_zindex_1 d-block"></a>
                        <div class="cs_portfolio_thumb d-block h-100 w-100 background-filled cs_transition_6"
                            data-src="<?php echo e(asset('front/img/portfolio_4.jpeg')); ?>"></div>
                        <h3
                            class="cs_portfolio_title m-0 cs_fs_26 text-white cs_pl_50 cs_pb_45 cs_mr_50 position-relative cs_zindex_4 position-absolute start-0 bottom-0 w-100 cs_transition_4">
                            <a href="project-details.html">Marketing Webdesign</a>
                        </h3>
    ...
    <section class="position-relative cs_iconbox_2_wrap cs_pt_135 cs_pt_lg_75 cs_pb_100 cs_pb_lg_40 overflow-hidden">
                    ...
                    <div class="position-relative cs_zindex_3">
                        <div
                            ...
                            <div class="cs_section_heading_in">
                                ...
                                <h2 class="cs_fs_48 cs_fs_lg_36 cs_mb_20 text-white">Developing a <span
                                        class="text-accent">design that <br>is easy</span> to use and <br>navigate</h2>
                                <p class="text-white m-0">Providing legal advice, contract drafting, compliance
                                    assistance, intellectual <br> property protection, and other legal support for
                                    businesses. Creating visual <br> content, such as logos, brochures, infographics.
                                </p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="cs_iconbox cs_style_1 d-flex align-items-center cs_mb_40">
                                    ...
                                    <div>
                                        <h2 class="text-white m-0 cs_fs_20 cs_fs_lg_18 cs_lh_base">Digital agency
                                            services</h2>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="cs_iconbox cs_style_1 d-flex align-items-center cs_mb_40">
                                    ...
                                    <div>
                                        <h2 class="text-white m-0 cs_fs_20 cs_fs_lg_18 cs_lh_base">Creative digital
                                            agency</h2>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="cs_iconbox cs_style_1 d-flex align-items-center cs_mb_40">
                                    ...
                                    <div>
                                        <h2 class="text-white m-0 cs_fs_20 cs_fs_lg_18 cs_lh_base">Super expert
                                            developers</h2>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="cs_iconbox cs_style_1 d-flex align-items-center cs_mb_40">
                                    ...
                                    <div>
                                        <h2 class="text-white m-0 cs_fs_20 cs_fs_lg_18 cs_lh_base">Creating a user
                                            friendly design</h2>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="cs_iconbox_right-img position-absolute cs_zindex_1 bottom-0 end-0 background-filled"
            data-src="<?php echo e(asset('front/img/why_choose_us_right_img.jpeg')); ?>"></div>
                            ...
                            <div class="cs_slide">
                                <div class="cs_testimonial cs_style_1 cs_pt_20">
                                    <div
                                        ...
                                        <div class="cs_testimonial_img cs_mb_15"><img
                                                src="<?php echo e(asset('front/img/avatar_1.png')); ?>" alt="Avatar"
                                                class="cs_height_75 cs_width_75 rounded-circle"></div>
                                        <div class="cs_rating text-accent cs_mb_15" data-rating="4.5">
                                            <div class="cs_rating_percentage"></div>
                                        </div>
                                        <p class="cs_mb_14">I've been using [business name] for the past year and I'm
                                            so glad I did. Their products and services are top-notch and their customer
                                            service is amazing. I would highly recommend them to anyone</p>
                            ...
                            <div class="cs_slide">
                                <div class="cs_testimonial cs_style_1 cs_pt_20">
                                    <div
                                        class="cs_testimonial_in bg-white shadow-sm cs_pl_30 cs_pr_30 cs_pb_27 cs_pt_1 cs_rounded_10">
                                        <div class="cs_testimonial_img cs_mb_15"><img
                                                src="<?php echo e(asset('front/img/avatar_2.png')); ?>" alt="Avatar"
                                                class="cs_height_75 cs_width_75 rounded-circle"></div>
                            ...
                            <div class="cs_slide">
                                <div class="cs_testimonial cs_style_1 cs_pt_20">
                                    <div
                                        class="cs_testimonial_in bg-white shadow-sm cs_pl_30 cs_pr_30 cs_pb_27 cs_pt_1 cs_rounded_10">
                                        <div class="cs_testimonial_img cs_mb_15"><img
                                                src="<?php echo e(asset('front/img/avatar_3.png')); ?>" alt="Avatar"
                                                class="cs_height_75 cs_width_75 rounded-circle"></div>
                            ...
                            <div class="cs_slide">
                                <div class="cs_testimonial cs_style_1 cs_pt_20">
                                    <div
                                        class="cs_testimonial_in bg-white shadow-sm cs_pl_30 cs_pr_30 cs_pb_27 cs_pt_1 cs_rounded_10">
                                        <div class="cs_testimonial_img cs_mb_15"><img
                                                src="<?php echo e(asset('front/img/avatar_4.png')); ?>" alt="Avatar"
                                                class="cs_height_75 cs_width_75 rounded-circle"></div>
                                        <div class="cs_rating text-accent cs_mb_15" data-rating="5">
                                            <div class="cs_rating_percentage"></div>
                                        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="cs_team cs_style_1 text-center cs_mb_25 overflow-hidden cs_rounded_50">
                        <div class="cs_team_member position-relative cs_rounded_50">
                            <img class="w-100 cs_rounded_50" src="<?php echo e(asset('front/img/team_member_1.jpg')); ?>"
                                alt="Member">
                            <div
                ...
                <div class="col-lg-4">
                    <div class="cs_team cs_style_1 text-center cs_mb_25 overflow-hidden cs_rounded_50">
                        <div class="cs_team_member position-relative cs_rounded_50">
                            <img class="w-100 cs_rounded_50" src="<?php echo e(asset('front/img/team_member_2.jpg')); ?>"
                                alt="Member">
                            <div
                                class="cs_social_btns d-flex flex-wrap cs_column_gap_15 cs_row_gap_15 cs_transition_5 cs_fs_20 cs_fs_lg_18 position-absolute">
                                <a href="#"
                ...
                <div class="col-lg-4">
                    <div class="cs_team cs_style_1 text-center cs_mb_25 overflow-hidden cs_rounded_50">
                        <div class="cs_team_member position-relative cs_rounded_50">
                            <img class="w-100 cs_rounded_50" src="<?php echo e(asset('front/img/team_member_3.jpg')); ?>"
                                alt="Member">
                            <div
                                class="cs_social_btns d-flex flex-wrap cs_column_gap_15 cs_row_gap_15 cs_transition_5 cs_fs_20 cs_fs_lg_18 position-absolute">
                                <a href="#"
            ...
            <div class="row align-items-center">
                <div class="col-xl-5 col-lg-6">
                    ...
                    <div class="d-flex align-items-center cs_mb_30">
                        ...
                        <div>
                            ...
                            <h2 class="text-white m-0 fw-medium cs_fs_22 cs_fs_lg_18 cs_lh_base"><a
                                    ...
                                    data-cfemail="3f5d5645525e477f535e4d5e53565154115c5052">[email&#160;protected]</a>
                            </h2>
                        </div>
                    </div>
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h2 class="text-white m-0 fw-medium cs_fs_22 cs_fs_lg_18 cs_lh_base">Yewtree Cottage, Kings
                                Pyon, <br>HR4 8PZ</h2>
                        </div>
                    </div>
                </div>
                <div class="col-xl-5 col-lg-6 offset-xl-1 cs_mt_lg_55">
                    <div class="cs_contact_wrap position-relative">
                        <form action="#"
                            class="cs_contact_form bg-white cs_pt_64 cs_pl_80 cs_pr_80 cs_pb_80 cs_pl_lg_30 cs_pr_lg_30 position-relative cs_rounded_20" data-src="">
                            ...
                            <button
                                class="cs_btn cs_style_1 cs_fs_16 cs_rounded_5 cs_pl_30 cs_pr_30 cs_pt_10 cs_pb_10 overflow-hidden"><span>Submit
                                    Now</span></button>
                        </form>
    ...
    <div class="cs_pt_140 cs_pt_lg_80">
        <div class="container">
            <div
                ...
                <div class="cs_brand"><img src="<?php echo e(asset('front/img/brand_1.svg')); ?>" alt="Brand"></div>
                <div class="cs_brand"><img src="<?php echo e(asset('front/img/brand_2.svg')); ?>" alt="Brand"></div>
                <div class="cs_brand"><img src="<?php echo e(asset('front/img/brand_3.svg')); ?>" alt="Brand"></div>
                <div class="cs_brand"><img src="<?php echo e(asset('front/img/brand_4.svg')); ?>" alt="Brand"></div>
                <div class="cs_brand"><img src="<?php echo e(asset('front/img/brand_5.svg')); ?>" alt="Brand"></div>
            </div>
        </div>
    </div>
    <!-- End Brands -->
            ...
            <div class="row">
                    ...
                    <div class="cs_post cs_style_1 bg-white shadow-sm cs_mb_30">
                        <a href="blog-details.html" class="cs_post_thumb d-block position-relative overflow-hidden">
                            <div class="cs_post_thumb-in cs_transition_5 background-filled h-100 w-100"
                                data-src="<?php echo e(asset('front/img/post_1.jpeg')); ?>"></div>
                        </a>
                        <div class="cs_post_in">
                            <div class="cs_post_info cs_pl_33 cs_pr_33 cs_pt_40 cs_pb_40">
                                ...
                                <h2 class="cs_post_title cs_lh_base cs_fs_20 cs_fs_lg_18 cs_mb_10"><a
                                        href="blog-details.html">What services does your business provide?</a></h2>
                                <div class="cs_post_subtitle">We provide a range of digital marketing lutions including
                                    website design.</div>
                            </div>
                ...
                <div class="col-lg-4">
                    <div class="cs_post cs_style_1 bg-white shadow-sm cs_mb_30">
                        <a href="blog-details.html" class="cs_post_thumb d-block position-relative overflow-hidden">
                            <div class="cs_post_thumb-in cs_transition_5 background-filled h-100 w-100"
                                data-src="<?php echo e(asset('front/img/post_2.jpeg')); ?>"></div>
                        </a>
                        <div class="cs_post_in">
                            <div class="cs_post_info cs_pl_33 cs_pr_33 cs_pt_40 cs_pb_40">
                                <ul class="cs_post_meta d-flex flex-wrap cs_fs_12 p-0 cs_mb_16">
                                ...
                                <h2 class="cs_post_title cs_lh_base cs_fs_20 cs_fs_lg_18 cs_mb_10"><a
                                        href="blog-details.html">Introducing the latest tech features for you</a></h2>
                                <div class="cs_post_subtitle">We provide a range of digital marketing lutions
                                    including website design.</div>
                            </div>
                            <a href="blog-details.html"
                                class="cs_post_btn d-flex justify-content-between align-items-center cs_pl_40 cs_pr_40 cs_pb_10 cs_pt_10">
                                <span class="cs_post_btn-text">Read More</span>
                ...
                <div class="col-lg-4">
                    <div class="cs_post cs_style_1 bg-white shadow-sm cs_mb_30">
                        <a href="blog-details.html" class="cs_post_thumb d-block position-relative overflow-hidden">
                            <div class="cs_post_thumb-in cs_transition_5 background-filled h-100 w-100"
                                data-src="<?php echo e(asset('front/img/post_3.jpeg')); ?>"></div>
                        </a>
                        <div class="cs_post_in">
                            <div class="cs_post_info cs_pl_33 cs_pr_33 cs_pt_40 cs_pb_40">
                                <ul class="cs_post_meta d-flex flex-wrap cs_fs_12 p-0 cs_mb_16">
                                ...
                                <h2 class="cs_post_title cs_lh_base cs_fs_20 cs_fs_lg_18 cs_mb_10"><a
                                        href="blog-details.html">The creative studio programm coming soon</a></h2>
                                <div class="cs_post_subtitle">We provide a range of digital marketing lutions
                                    including website design.</div>
                            </div>
                            <a href="blog-details.html"
