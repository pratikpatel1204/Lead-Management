...
$(document).ready(function() {
    $('#mobile_no').on('keyup', function() {
        ...
        if(query.length >= 3) {  // start searching after 3 digits
            $.ajax({
                url: "<?php echo e(route('get.vehicles.by.mobile')); ?>",
                type: "GET",
...
<?php echo $__env->make('layout.main-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\siddhivinayakpump\resources\views/redeem/create.blade.php ENDPATH**/ ?>