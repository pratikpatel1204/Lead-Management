...
<?php $__env->startSection('title', config('app.name') . ' || Edit Validation Type'); ?>
            ...
            <div class="card-body">
                <form id="validationForm" method="POST">
                    ...
                    <div class="row">
                        ...
                        <input type="hidden" name="id" value="<?php echo e($validationType->id); ?>">
                        <!-- Validation Name -->
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Validation Name <span class="text-danger">*</span></label>
                            <input type="text" name="name" value="<?php echo e($validationType->name); ?>" class="form-control"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="rule" value="<?php echo e($validationType->rule); ?>" class="form-control"
    ...
    <script>
        $(document).ready(function() {
            $("#validationForm").on('submit', function(e) {
                ...
                $.ajax({
                    url: "<?php echo e(route('admin.validation.update', $validationType->id)); ?>",
                    type: "POST",
                    data: formData,
                    contentType: false,
                    processData: false,
...
<?php echo $__env->make('admin.layout.main-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Lead-Management\resources\views/admin/field/validation_edit.blade.php ENDPATH**/ ?>