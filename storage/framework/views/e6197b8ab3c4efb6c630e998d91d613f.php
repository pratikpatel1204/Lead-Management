...
<?php $__env->startSection('title', config('app.name') . ' || Our Team'); ?>
                    ...
                    <div class="col-lg-4">
                        <div class="cs_team cs_style_1 text-center cs_mb_25 overflow-hidden cs_rounded_50">
                            <div class="cs_team_member position-relative cs_rounded_50">
                                <img class="w-100 cs_rounded_50" src="<?php echo e(asset($team->image)); ?>" alt="<?php echo e($team->name); ?>">
                                <div
...
<?php echo $__env->make('front.layout.main-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Lead-Management\resources\views/front/team.blade.php ENDPATH**/ ?>