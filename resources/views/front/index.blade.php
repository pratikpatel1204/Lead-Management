...
@section('content')
                    ...
                    @foreach ($banners as $banner)
                        <div class="swiper-slide">
                            <div
                                ...
                                <figure class="cs_swiper_parallax_bg" data-src="{{ asset($banner->image) }}">
                                    <img src="{{ asset($banner->image) }}" alt="{{ $banner->title }}" class="cs_entity_img">
                                ...
                                <div class="container">
                                    <div class="cs_hero_text position-relative cs_zindex_5 d-inline-block">
                                        <h1 class="text-white cs_mb_16 cs_fs_60 cs_fs_lg_30">{{ $banner->title }}</h1>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="cs_moving_wrap background-filled text-uppercase text-white d-flex align-items-center"
        ...
        <div class="cs_moving_text cs_fs_30 cs_fs_lg_26 d-flex align-items-center text-nowrap">
            @foreach ($servicecategory as $servicecat)
                <span>* {{ $servicecat->title }}</span>
            @endforeach
        </div>
    </div>
    <!-- End Animated Text -->
                        ...
                        <div
                            ...
                            <div class="cs_service_iconbox d-flex align-items-center cs_mb_20">
                                <h2 class="cs_lh_base cs_fs_20 cs_fs_lg_18 m-0">
                                    <a href="{{ route('front.service.details', $service->slug) }}"
                                        class="inline-block">{{ $service->title }}</a>
                                </h2>
                            </div>
                            ...
                            <div class="cs_service_thumb position-relative cs_rounded_5">
                                ...
                                <div class="cs_service_thumb-in position-relative-in background-filled h-100"
                                    data-src="{{ asset($service->image) }}"></div>
                            </div>
                        </div>
                    </div>
                @endforeach
                ...
                <div class="col-lg-6 cs_mb_lg_55">
                    <div class="cs_experience cs_style_1 position-relative">
                        <div class="cs_experience_thumb">
                            <img src="{{ asset($abouts->main_image) }}" alt="Thumb"
                                class="position-relative cs_zindex_3 cs_rounded_15">
                            <div class="cs_experience_shape">
                                <img src="{{ asset('front/img/experience_shape_1.png') }}" alt="Shape"
                                    class="moving_x">
                            </div>
                        </div>
                        <div class="cs_experience_box background-filled text-center bg-white cs_rounded_10 position-absolute bottom-0 end-0 cs_zindex_3 d-flex flex-column justify-content-center align-items-center"
                            data-src="{{ asset($abouts->second_image) }}">
                    ...
                    <div class="cs_about cs_style_1">
                        <div class="cs_section_heading cs_style_1 d-flex align-items-center cs_mb_15">
                            <div class="cs_section_heading_in">
                                ...
                                <h2 class="cs_fs_48 cs_fs_lg_36 cs_mb_20">{!! $abouts->title !!}</h2>
    ...
    <section class="position-relative cs_iconbox_2_wrap cs_pt_135 cs_pt_lg_75 cs_pb_100 cs_pb_lg_40 overflow-hidden">
                    ...
                    <div class="position-relative cs_zindex_3">
                        <div
                            ...
                            <div class="cs_section_heading_in">
                                ...
                                <h2 class="cs_fs_48 cs_fs_lg_36 cs_mb_20 text-white">{{$choose_us->title}}</h2>
                                <p class="text-white m-0">{{$choose_us->short_description}}</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="cs_iconbox cs_style_1 d-flex align-items-center cs_mb_40">
                                    ...
                                    <div>
                                        <h2 class="text-white m-0 cs_fs_20 cs_fs_lg_18 cs_lh_base">{{$choose_us->list_one}}</h2>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="cs_iconbox cs_style_1 d-flex align-items-center cs_mb_40">
                                    ...
                                    <div>
                                        <h2 class="text-white m-0 cs_fs_20 cs_fs_lg_18 cs_lh_base">{{$choose_us->list_two}}</h2>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="cs_iconbox cs_style_1 d-flex align-items-center cs_mb_40">
                                    ...
                                    <div>
                                        <h2 class="text-white m-0 cs_fs_20 cs_fs_lg_18 cs_lh_base">{{$choose_us->list_three}}</h2>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="cs_iconbox cs_style_1 d-flex align-items-center cs_mb_40">
                                    ...
                                    <div>
                                        <h2 class="text-white m-0 cs_fs_20 cs_fs_lg_18 cs_lh_base">{{$choose_us->list_four}}</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="cs_iconbox_right-img position-absolute cs_zindex_1 bottom-0 end-0 background-filled"
            data-src="{{ asset($choose_us->image) }}"></div>
                                    ...
                                    <div class="cs_testimonial cs_style_1 cs_pt_20">
                                        <div
                                            ...
                                            <div class="cs_rating text-accent cs_mb_15"
                                                data-rating="{{ $testimonial->star }}">
                                                <div class="cs_rating_percentage"></div>
                                            </div>
                                            <p class="cs_mb_14">{!! $testimonial->message !!}</p>
                                            <h3 class="cs_fs_18 cs_mb_2 cs_lh_base">{{ $testimonial->name }}</h3>
                                            <p class="m-0 cs_fs_14 cs_lh_base">{{ $testimonial->designation }}</p>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
                    ...
                    <div class="col-lg-4">
                        <div class="cs_team cs_style_1 text-center cs_mb_25 overflow-hidden cs_rounded_50">
                            <div class="cs_team_member position-relative cs_rounded_50">
                                <img class="w-100 cs_rounded_50" src="{{ asset($team->image) }}"
                                    alt="{{ $team->name }}">
                                <div
                ...
                <div class="col-xl-5 col-lg-6">
                    ...
                    <div class="d-flex align-items-center cs_mb_30">
                        ...
                        <div>
                            ...
                            <h2 class="text-white m-0 fw-medium cs_fs_22 cs_fs_lg_18 cs_lh_base">{{ $contact->phone }}
                            </h2>
                        </div>
                    </div>
                    <div class="d-flex align-items-center cs_mb_30">
                        ...
                        <div>
                            ...
                            <h2 class="text-white m-0 fw-medium cs_fs_22 cs_fs_lg_18 cs_lh_base">{{ $contact->email }}
                            </h2>
                        </div>
                    </div>
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h2 class="text-white m-0 fw-medium cs_fs_22 cs_fs_lg_18 cs_lh_base">{{ $contact->address }}
                            </h2>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="cs_post_info cs_pl_33 cs_pr_33 cs_pt_40 cs_pb_40">
                                    <ul class="cs_post_meta d-flex flex-wrap cs_fs_12 p-0 cs_mb_16">
                                        <li>
                                            ...
                                            <a
                                                href="{{ route('front.blog.details', $blog->slug) }}">{{ $blog->author_name }}</a>
                                        </li>
                                        <li>
                                    ...
                                    <div class="cs_post_subtitle">{!! Str::limit($blog->short_description, 100) !!}</div>
                                </div>
                                <a href="{{ route('front.blog.details', $blog->slug) }}"
