...
@section('content')
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div
                            ...
                            <figure class="cs_swiper_parallax_bg" data-src="{{ asset('front/img/hero_slider_1.jpg') }}">
                                <img src="{{ asset('front/img/hero_slider_1.jpg') }}" alt="Slider" class="cs_entity_img">
                    ...
                    <div class="swiper-slide">
                        <div
                            class="cs_hero cs_style_1 d-flex align-items-center justify-content-center background-filled position-relative overflow-hidden">
                            <figure class="cs_swiper_parallax_bg" data-src="{{ asset('front/img/hero_slider_2.jpg') }}">
                                <img src="{{ asset('front/img/hero_slider_2.jpg') }}" alt="Slider" class="cs_entity_img">
                                <div class="bg-primary opacity-75 position-absolute w-100 h-100 start-0 top-0"></div>
                            </figure>
                            <div class="container">
                                <div class="cs_hero_text position-relative cs_zindex_5 d-inline-block">
                    ...
                    <div class="swiper-slide">
                        <div
                            class="cs_hero cs_style_1 d-flex align-items-center justify-content-center background-filled position-relative overflow-hidden">
                            <figure class="cs_swiper_parallax_bg" data-src="{{ asset('front/img/hero_slider_3.jpg') }}">
                                <img src="{{ asset('front/img/hero_slider_3.jpg') }}" alt="Slider" class="cs_entity_img">
                                <div class="bg-primary opacity-75 position-absolute w-100 h-100 start-0 top-0"></div>
                            </figure>
                            <div class="container">
                                <div class="cs_hero_text position-relative cs_zindex_5 d-inline-block">
    ...
    <div class="cs_moving_wrap background-filled text-uppercase text-white d-flex align-items-center"
        data-src="{{ asset('front/img/moving_text_shape.png') }}">
    ...
    <section class="background-filled cs_pt_133 cs_pt_lg_75 cs_pb_140 cs_pb_lg_80 cs_gray_bg"
        data-src="{{ asset('front/img/services_bg.jpeg') }}">
        <div class="container">
            <div
                    ...
                    <div
                        ...
                        <div class="cs_service_thumb position-relative cs_rounded_5">
                            ...
                            <div class="cs_service_thumb-in position-relative-in background-filled h-100"
                                data-src="{{ asset('front/img/service_1.jpeg') }}"></div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6">
                    <div
                        ...
                        <div class="cs_service_thumb position-relative cs_rounded_5">
                            ...
                            <div class="cs_service_thumb-in position-relative-in background-filled h-100"
                                data-src="{{ asset('front/img/service_2.jpeg') }}"></div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6">
                    <div
                        ...
                        <div class="cs_service_thumb position-relative cs_rounded_5">
                            ...
                            <div class="cs_service_thumb-in position-relative-in background-filled h-100"
                                data-src="{{ asset('front/img/service_3.jpeg') }}"></div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6">
                    <div
                        ...
                        <div class="cs_service_thumb position-relative cs_rounded_5">
                            ...
                            <div class="cs_service_thumb-in position-relative-in background-filled h-100"
                                data-src="{{ asset('front/img/service_4.jpeg') }}"></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-6 cs_mb_lg_55">
                    <div class="cs_experience cs_style_1 position-relative">
                        <div class="cs_experience_thumb">
                            <img src="{{ asset('front/img/experience_img.jpg') }}" alt="Thumb"
                                class="position-relative cs_zindex_3 cs_rounded_15">
                            <div class="cs_experience_shape"><img src="{{ asset('front/img/experience_shape_1.png') }}"
                        ...
                        <div class="cs_experience_box background-filled text-center bg-white cs_rounded_10 position-absolute bottom-0 end-0 cs_zindex_3 d-flex flex-column justify-content-center align-items-center"
                            data-src="{{ asset('front/img/experience_bg.jpeg') }}">
                            <img src="{{ asset('front/img/experience_icon.svg') }}" alt="Icon" class="cs_mb_5">
                ...
                <div class="cs_slide">
                    <div class="cs_portfolio cs_style_1 position-relative overflow-hidden">
                        ...
                        <div class="cs_portfolio_thumb d-block h-100 w-100 background-filled cs_transition_6"
                            data-src="{{ asset('front/img/portfolio_1.jpeg') }}"></div>
                        <h3
                ...
                <div class="cs_slide">
                    <div class="cs_portfolio cs_style_1 position-relative overflow-hidden">
                        <a href="project-details.html"
                            class="cs_portfolio_overlay cs_transition_4 position-absolute h-100 w-100 start-0 top-0 cs_zindex_1 d-block"></a>
                        <div class="cs_portfolio_thumb d-block h-100 w-100 background-filled cs_transition_6"
                            data-src="{{ asset('front/img/portfolio_2.jpeg') }}"></div>
                        <h3
                            class="cs_portfolio_title m-0 cs_fs_26 text-white cs_pl_50 cs_pb_45 cs_mr_50 position-relative cs_zindex_4 position-absolute start-0 bottom-0 w-100 cs_transition_4">
                            <a href="project-details.html">Marketing Webdesign</a>
                        </h3>
                ...
                <div class="cs_slide">
                    <div class="cs_portfolio cs_style_1 position-relative overflow-hidden">
                        <a href="project-details.html"
                            class="cs_portfolio_overlay cs_transition_4 position-absolute h-100 w-100 start-0 top-0 cs_zindex_1 d-block"></a>
                        <div class="cs_portfolio_thumb d-block h-100 w-100 background-filled cs_transition_6"
                            data-src="{{ asset('front/img/portfolio_3.jpeg') }}"></div>
                        <h3
                            class="cs_portfolio_title m-0 cs_fs_26 text-white cs_pl_50 cs_pb_45 cs_mr_50 position-relative cs_zindex_4 position-absolute start-0 bottom-0 w-100 cs_transition_4">
                            <a href="project-details.html">Marketing Webdesign</a>
                        </h3>
                ...
                <div class="cs_slide">
                    <div class="cs_portfolio cs_style_1 position-relative overflow-hidden">
                        <a href="project-details.html"
                            class="cs_portfolio_overlay cs_transition_4 position-absolute h-100 w-100 start-0 top-0 cs_zindex_1 d-block"></a>
                        <div class="cs_portfolio_thumb d-block h-100 w-100 background-filled cs_transition_6"
                            data-src="{{ asset('front/img/portfolio_4.jpeg') }}"></div>
                        <h3
                            class="cs_portfolio_title m-0 cs_fs_26 text-white cs_pl_50 cs_pb_45 cs_mr_50 position-relative cs_zindex_4 position-absolute start-0 bottom-0 w-100 cs_transition_4">
                            <a href="project-details.html">Marketing Webdesign</a>
                        </h3>
    ...
    <section class="position-relative cs_iconbox_2_wrap cs_pt_135 cs_pt_lg_75 cs_pb_100 cs_pb_lg_40 overflow-hidden">
        ...
        <div class="cs_iconbox_left-img position-absolute bottom-0 start-0 h-100 background-filled"
            data-src="{{ asset('front/img/why_choose_us_left_img.jpeg') }}"></div>
        <div class="cs_iconbox_right-img position-absolute cs_zindex_1 bottom-0 end-0 background-filled"
            data-src="{{ asset('front/img/why_choose_us_right_img.jpeg') }}"></div>
                                ...
                                <div class="cs_testimonial cs_style_1 cs_pt_20">
                                    <div
                                        ...
                                        <div class="cs_testimonial_img cs_mb_15"><img
                                                src="{{ asset('front/img/avatar_1.png') }}" alt="Avatar"
                            ...
                            <div class="cs_slide">
                                <div class="cs_testimonial cs_style_1 cs_pt_20">
                                    <div
                                        class="cs_testimonial_in bg-white shadow-sm cs_pl_30 cs_pr_30 cs_pb_27 cs_pt_1 cs_rounded_10">
                                        <div class="cs_testimonial_img cs_mb_15"><img
                                                src="{{ asset('front/img/avatar_2.png') }}" alt="Avatar"
                                                class="cs_height_75 cs_width_75 rounded-circle"></div>
                            ...
                            <div class="cs_slide">
                                <div class="cs_testimonial cs_style_1 cs_pt_20">
                                    <div
                                        class="cs_testimonial_in bg-white shadow-sm cs_pl_30 cs_pr_30 cs_pb_27 cs_pt_1 cs_rounded_10">
                                        <div class="cs_testimonial_img cs_mb_15"><img
                                                src="{{ asset('front/img/avatar_3.png') }}" alt="Avatar"
                                                class="cs_height_75 cs_width_75 rounded-circle"></div>
                            ...
                            <div class="cs_slide">
                                <div class="cs_testimonial cs_style_1 cs_pt_20">
                                    <div
                                        class="cs_testimonial_in bg-white shadow-sm cs_pl_30 cs_pr_30 cs_pb_27 cs_pt_1 cs_rounded_10">
                                        <div class="cs_testimonial_img cs_mb_15"><img
                                                src="{{ asset('front/img/avatar_4.png') }}" alt="Avatar"
                                                class="cs_height_75 cs_width_75 rounded-circle"></div>
                                        <div class="cs_rating text-accent cs_mb_15" data-rating="5">
                                            <div class="cs_rating_percentage"></div>
                                        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="cs_team cs_style_1 text-center cs_mb_25 overflow-hidden cs_rounded_50">
                        <div class="cs_team_member position-relative cs_rounded_50">
                            <img class="w-100 cs_rounded_50" src="{{ asset('front/img/team_member_1.jpg') }}"
                                alt="Member">
                            <div
                ...
                <div class="col-lg-4">
                    <div class="cs_team cs_style_1 text-center cs_mb_25 overflow-hidden cs_rounded_50">
                        <div class="cs_team_member position-relative cs_rounded_50">
                            <img class="w-100 cs_rounded_50" src="{{ asset('front/img/team_member_2.jpg') }}"
                                alt="Member">
                            <div
                                class="cs_social_btns d-flex flex-wrap cs_column_gap_15 cs_row_gap_15 cs_transition_5 cs_fs_20 cs_fs_lg_18 position-absolute">
                                <a href="#"
                ...
                <div class="col-lg-4">
                    <div class="cs_team cs_style_1 text-center cs_mb_25 overflow-hidden cs_rounded_50">
                        <div class="cs_team_member position-relative cs_rounded_50">
                            <img class="w-100 cs_rounded_50" src="{{ asset('front/img/team_member_3.jpg') }}"
                                alt="Member">
                            <div
                                class="cs_social_btns d-flex flex-wrap cs_column_gap_15 cs_row_gap_15 cs_transition_5 cs_fs_20 cs_fs_lg_18 position-absolute">
                                <a href="#"
    ...
    <section class="background-filled overflow-hidden cs_pt_133 cs_pt_lg_75 cs_pb_140 cs_pb_lg_80"
        data-src="{{ asset('front/img/cta_bg.jpeg') }}">
        <div class="container">
                ...
                <div class="col-xl-5 col-lg-6 offset-xl-1 cs_mt_lg_55">
                    <div class="cs_contact_wrap position-relative">
                        ...
                        <div class="cs_contact_image d-none d-xl-block wow fadeInRight" data-wow-duration="0.8s"
                            data-wow-delay="0.4s"><img src="{{ asset('front/img/contact_img_1.png') }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="cs_pt_140 cs_pt_lg_80">
        <div class="container">
            <div
                ...
                <div class="cs_brand"><img src="{{ asset('front/img/brand_1.svg') }}" alt="Brand"></div>
                <div class="cs_brand"><img src="{{ asset('front/img/brand_2.svg') }}" alt="Brand"></div>
                <div class="cs_brand"><img src="{{ asset('front/img/brand_3.svg') }}" alt="Brand"></div>
                <div class="cs_brand"><img src="{{ asset('front/img/brand_4.svg') }}" alt="Brand"></div>
                <div class="cs_brand"><img src="{{ asset('front/img/brand_5.svg') }}" alt="Brand"></div>
            </div>
        </div>
    </div>
    <!-- End Brands -->
            ...
            <div class="row">
                    ...
                    <div class="cs_post cs_style_1 bg-white shadow-sm cs_mb_30">
                        <a href="blog-details.html" class="cs_post_thumb d-block position-relative overflow-hidden">
                            <div class="cs_post_thumb-in cs_transition_5 background-filled h-100 w-100"
                                data-src="{{ asset('front/img/post_1.jpeg') }}"></div>
                        </a>
                ...
                <div class="col-lg-4">
                    <div class="cs_post cs_style_1 bg-white shadow-sm cs_mb_30">
                        <a href="blog-details.html" class="cs_post_thumb d-block position-relative overflow-hidden">
                            <div class="cs_post_thumb-in cs_transition_5 background-filled h-100 w-100"
                                data-src="{{ asset('front/img/post_2.jpeg') }}"></div>
                        </a>
                        <div class="cs_post_in">
                            <div class="cs_post_info cs_pl_33 cs_pr_33 cs_pt_40 cs_pb_40">
                                <ul class="cs_post_meta d-flex flex-wrap cs_fs_12 p-0 cs_mb_16">
                ...
                <div class="col-lg-4">
                    <div class="cs_post cs_style_1 bg-white shadow-sm cs_mb_30">
                        <a href="blog-details.html" class="cs_post_thumb d-block position-relative overflow-hidden">
                            <div class="cs_post_thumb-in cs_transition_5 background-filled h-100 w-100"
                                data-src="{{ asset('front/img/post_3.jpeg') }}"></div>
                        </a>
                        <div class="cs_post_in">
                            <div class="cs_post_info cs_pl_33 cs_pr_33 cs_pt_40 cs_pb_40">
                                <ul class="cs_post_meta d-flex flex-wrap cs_fs_12 p-0 cs_mb_16">
