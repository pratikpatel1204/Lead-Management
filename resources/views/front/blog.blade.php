                ...
                <div class="col-lg-8">
                    @foreach ($allBlogs as $blog)
                        <div class="cs_post cs_style_1 bg-white shadow-sm cs_mb_40">
                            <a href="{{ route('front.blog.details', $blog->slug) }}" class="cs_post_thumb d-block position-relative overflow-hidden">
                            ...
                            <div
                                ...
                                <ul class="cs_post_meta d-flex flex-wrap cs_fs_12 p-0 cs_mb_20">
                                    ...
                                    <li>
                                        ...
                                        <a href="{{ route('front.blog.details', $blog->slug) }}">{{ $blog->created_at->format('F d, Y') }}</a>
                                    </li>
                                </ul>
                                <h2 class="cs_post_title cs_lh_base cs_fs_26 cs_fs_lg_18 cs_mb_20">
                                    <a href="{{ route('front.blog.details', $blog->slug) }}">{{ $blog->title }}</a></h2>
                                <div class="cs_post_subtitle cs_mb_30">{{$blog->short_description}}</div>
                        ...
                        <div class="cs_sidebar_item widget_categories">
                            ...
                            <ul>
                                @foreach ($blogCategories as $category)
                                    <li class="cat-item">
                                        <a href="{{ route('front.blog.category', $category->slug) }}">{{ $category->name }}</a>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
