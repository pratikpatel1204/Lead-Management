...
@section('content')
                    ...
                    <div class="cs_pl_60 cs_pl_lg_0 cs_pt_lg_60">
                        ...
                        <div class="d-flex align-items-center cs_mb_30">
                            ...
                            <div>
                                ...
                                <h2 class="m-0 fw-medium cs_fs_22 cs_fs_lg_18 cs_lh_base">{{ $contact->phone }}</h2>
                            </div>
                        </div>
                        <div class="d-flex align-items-center cs_mb_30">
                            <div
                            ...
                            <div>
                                ...
                                <h2 class="m-0 fw-medium cs_fs_22 cs_fs_lg_18 cs_lh_base">{{ $contact->email }}</h2>
                            </div>
                        </div>
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <h2 class="m-0 fw-medium cs_fs_22 cs_fs_lg_18 cs_lh_base">{{ $contact->address }}</h2>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- Start Google Map -->
    <div class="cs_map">
        <iframe id="map" src="{{ $contact->map_link }}" allowfullscreen></iframe>
    </div>
    <!-- End Google Map -->
    <script>
        $('#inquiryForm').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{ route('front.contact.inquery') }}",
                method: 'POST',
                data: formData,
