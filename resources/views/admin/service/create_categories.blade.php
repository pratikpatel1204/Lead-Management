...
@section('title', config('app.name') . ' || Create Category')
                ...
                <div class="card-body">
                    <form id="categoryForm" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="title" class="form-control" required placeholder="Enter Category Title">
...
$("#categoryForm").on('submit', function(e) {
    ...
    $.ajax({
        url: "{{ route('admin.services.categories.store') }}",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
