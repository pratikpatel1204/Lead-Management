...
@section('title', config('app.name') . ' || Edit Blog')
                ...
                <div class="card-body">
                    <form id="blogForm" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="author_name" class="form-control" value="{{ $blog->author_name }}" placeholder="Enter Author Name">
                            <span class="text-danger error-author_name"></span>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Short Description</label>
                            <textarea name="short_description" class="form-control" rows="3" placeholder="Enter Short Description">{{ $blog->short_description }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            @if($blog->image)
                                <div class="mb-2">
                                    <img src="{{ asset($blog->image) }}" alt="Blog Image" class="img-thumbnail" width="150">
                                </div>
                            @endif
